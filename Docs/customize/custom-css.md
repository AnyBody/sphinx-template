...
as described in the [ReadTheDocs Docs](https://docs.readthedocs.com/platform/stable/guides/adding-custom-css.html#how-to-add-custom-css-or-javascript-to-sphinx-documentation).
